...
from the prose. A table or an example belongs in an indented block, not a fenced one.
...
of the building, because all four are on the wall's own plane.
...
third of the frame is lawn and sky at flat tones.
